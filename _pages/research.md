...
With the successfully launch and operation of JWST, we have entered a new era. I have led a comprehensive search of the AGN population across the cosmic time in the GOODS/HUDF regions with a combination of SMILES/MIRI and JADES/NIRCam data (see [paper](https://ui.adsabs.harvard.edu/abs/2024ApJ...966..229L)). We have demonstrated the new discovery space enabled by JWST/MIRI and report huge progresses in the search of obscured AGNs in normal galaxies, dwarf galaxies and high-z Universe. Before that, I have also conducted AGN identifications with the deepest X-ray, mid-IR and radio data in the pre-JWST era (see [paper](https://ui.adsabs.harvard.edu/abs/2022ApJ...941..191L)), showing that no single band or technique is close to reach a complete AGN sample.

Looking ahead, as a co-PI of the [COSMOS-3D program](https://ui.adsabs.harvard.edu/abs/2024jwst.prop.5893K/abstract), we will carry out a 500 arcmin^2 MIRI survey with NIRCam image and wide-field-slitless spectroscopy observations in the COSMOS field. Stay tuned for the exciting results from this large JWST legacy program!
</div>
<div class="col-sm-4">
...
understand the AGN IR emission. This includes the characterization of AGN intrinsic IR SED variations (see [paper](https://ui.adsabs.harvard.edu/abs/2017ApJ...835..257L)), constrain the SED shape of the AGN-heated dust far-IR emission (see [paper](https://ui.adsabs.harvard.edu/abs/2017ApJ...841...76L)), and reveal the role of polar dust, or narrow-line-region dust (see [paper](https://ui.adsabs.harvard.edu/abs/2018ApJ...866...92L), [paper](https://ui.adsabs.harvard.edu/abs/2022ApJ...940L..31L)). In addition, we have also probed the structures of AGN dust torus through near- to mid-IR dust reverberation mapping techniques and studied their connection with the AGN IR SEDs (see [paper](https://ui.adsabs.harvard.edu/abs/2019ApJ...886...33L), [paper](https://ui.adsabs.harvard.edu/abs/2021ApJ...912..126L)).
...
<div class="col-sm-8 col-xs-12">
I have pioneered to use the NEOWISE mid-IR time domain data and ground-based optical transient surveys to conduct statistical dust-reverberation mappings of quasars (see [paper](https://ui.adsabs.harvard.edu/abs/2019ApJ...886...33L)). We have also carried out a detailed multi-band near- to mid-IR reverberation analysis of the famous type-1 AGN NGC 4151 with archival data collected over 30 years and observationally constrained the AGN torus structures from the very inner part to the outer edges for the first time (see [paper](https://ui.adsabs.harvard.edu/abs/2021ApJ...912..126L)).

Besides the study of AGN, I have also involved in the mid-IR time-domain study of tidal disruption events (TDE, see e.g., [paper](https://ui.adsabs.harvard.edu/abs/2016ApJ...828L..14J/abstract), [paper](https://ui.adsabs.harvard.edu/abs/2016ApJ...832..188D/abstract)).
</div>
<div class="col-sm-4">
